  ...
  return (
    <nav className="flex w-full flex-row-reverse bg-white py-5 px-5 dark:bg-[#261C2C] md:flex-row md:justify-between">
      <div
        className={`${
          navVisible ? "" : "hidden"
        } absolute mt-12 rounded-lg border border-[#FFEDDB] bg-[#FFEDDB] p-3 text-xl dark:border-[#3E2C41] dark:bg-[#3E2C41] md:static md:mt-0 md:block md:border-none md:bg-transparent md:p-0 md:text-2xl`}
      >
